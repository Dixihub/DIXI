...
#if defined(NDEBUG)
# error "DIXI cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 17 * 60 * 60;
...
const string strMessageMagic = "DIXI Signed Message:\n";
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
    ...
    else if (pindexLast->nHeight < 786000)
