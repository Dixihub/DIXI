...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " DIXI");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " DIXI");
    }
}
...
void BlockBrowser::updateStatistics()
{
   ...
   // pwalletMain->GetStakeWeight(*pwalletMain, nWeight, nMaxWeight);
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"blue\">" + qVolume + " DIXI" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " DIXI" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " DIXI");
    }
    updatePrevious(nHeight, nStakeMinConfirmations, nNetworkWeight, phase, nSubsidy, pHardness, pHardness2, pPawrate2, Qlpawrate, peers, volume);
}
